 ...
 * avoided by NEVER letting an interrupt change a buffer (except for the data,
 * of course), but instead letting the caller do it. NOTE! As interrupts
...
extern int end;			/* defined in kernel/rs_io.S */
...
/*
 * bread() reads a specified block and returns the buffer that contains it.
